...
Status: **v0.6.0-alpha.0 — M6 closed (PLAN phase + repo-context MVP + Scientist substrate + `budgets.global`)**. Tagged locally on `main`, not yet pushed. 783 offline tests pass. M7-M10 split per the M7-M10 shape debate (2026-04-30, `docs/research/CODEX_RESPONSE_M7_M10_SHAPE.md`): M7 = worktree contract + BUILD-lite, M8 = VERIFY-lite + restart-on-fail, M9 = REVIEW-lite, M10 = Debate runtime. Read `docs/design/ROADMAP.md` first.
