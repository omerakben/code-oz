...
describe('finding #1: versions report 0.6.0-alpha.0 across all surfaces', () => {
  test('PKG_VERSION', () => {
    expect(PKG_VERSION).toBe('0.6.0-alpha.0')
  })

  test('DEFAULT_CONFIG.version', () => {
    expect(DEFAULT_CONFIG.version).toBe('0.6.0-alpha.0')
  })
  ...
  test('package.json.version', async () => {
    ...
    expect(pkg.version).toBe('0.6.0-alpha.0')
  })
})
